...
class stage01_quantification_physiologicalRatios_dependencies():
    # variables:
    ratios = {'accoa_ratio':{'component_group_name':["accoa","coa"],'name':'Ac(CoA) Ratio','description':'accoa/(coa+accoa)'},
